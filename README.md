...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-characteristic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13127&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-characteristic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-characteristic` can be installed with:

```
conda install types-characteristic
```

It is possible to list all of the versions of `types-characteristic` available on your platform with:
